 ...
 * 房子
*/
public class Group_HouseWall_Small implements Simple_Group{
	...
	public TransformGroup createSceneGraph(){
		...
		String str_wall1 = "E:/java/picture/java3D/qiangsheng.jpg";
		String str_wall2 = "E:/java/picture/java3D/qiangtou.jpg";
...
/****墙****/
		...
		Shape3D shape3 = new Shape3D_HouseWall().createShape3D(p3,str_wall2,index3);
		Shape3D shape4 = new Shape3D_HouseWall().createShape3D(p4,str_wall1,index4);
		Shape3D shape5 = new Shape3D_HouseWall().createShape3D(p5,str_wall2,index5);
		Shape3D shape6 = new Shape3D_HouseWall().createShape3D(p6,str_wall1,index6);
		Shape3D shape7 = new Shape3D_HouseWall().createShape3D(p7,str_wall2,index7);
