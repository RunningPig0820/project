 ...
 * 房子
*/
public class Group_HouseWall2_Great implements Simple_Group,Serializable{
	...
	public TransformGroup createSceneGraph(){
		...
		Texture2D str_wall1 = new Texture().gettex("E:/java/picture/java3D/qinagsheng2.jpg");
...
/****墙****/
		...
		Shape3D shape3 = new Shape3D_HouseWall_Great().createShape3D(p3,str_wall1,index3);
		Shape3D shape4 = new Shape3D_HouseWall_Great().createShape3D(p4,str_wall1,index4);
		Shape3D shape5 = new Shape3D_HouseWall_Great().createShape3D(p5,str_wall1,index4);
		Shape3D shape6 = new Shape3D_HouseWall_Great().createShape3D(p6,str_wall1,index4);
		Shape3D shape7 = new Shape3D_HouseWall_Great().createShape3D(p7,str_wall1,index4);
