...
public class World_Houses implements Simple_Group{
	...
	public World_Houses(Client client){
		this.client = client;
	}
	...
	public void gethouses(){
		...
		for(int i = 0 ; i < 9; i++){
			for(int j = 0 ; j < 9 ; j++){
				t1.setTranslation(new Vector3f(-1.0f-2*i,0.0f,-12.0f+j*3));
