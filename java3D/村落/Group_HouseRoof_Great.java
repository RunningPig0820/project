 ...
 * 房子
*/
public class Group_HouseRoof_Great implements Simple_Group,Serializable{
	...
	public TransformGroup createSceneGraph(){
		...
		Texture2D str_roof = new Texture().gettex("E:/java/picture/java3D/Roof.jpg");
		Texture2D str_roof1 = new Texture().gettex("E:/java/picture/java3D/fangyan.jpg");
...
/*****屋顶******/
		...
		Shape3D shape1 = new Shape3D_HouseWall_Great().createShape3D(p1,str_roof,index);
		Shape3D shape2 = new Shape3D_HouseWall_Great().createShape3D(p2,str_roof,index);
		Shape3D shape3 = new Shape3D_HouseWall_Great().createShape3D(p3,str_roof,index);
		Shape3D shape4 = new Shape3D_HouseWall_Great().createShape3D(p4,str_roof,index);
		Shape3D shape5 = new Shape3D_HouseWall_Great().createShape3D(p5,str_roof1,index);
		Shape3D shape6 = new Shape3D_HouseWall_Great().createShape3D(p6,str_roof1,index);
		Shape3D shape7 = new Shape3D_HouseWall_Great().createShape3D(p7,str_roof,index);
		Shape3D shape8 = new Shape3D_HouseWall_Great().createShape3D(p8,str_roof,index);
